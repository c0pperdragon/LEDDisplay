...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLLHDMI -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25.35 -fclkop 253.5 -fclkop_tol 0.0 -fclkos 253.5 -fclkos_tol 0.0 -fclkos2 253.5 -fclkos2_tol 0.0 -fclkos3 253.5 -fclkos3_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 45 -trims_r -phases2 90 -phases3 135 -phase_cntl STATIC -fb_mode 1 

-- Wed Jan 07 15:36:30 2026
...
architecture Structure of PLLHDMI is
    ...
    attribute FREQUENCY_PIN_CLKOS3 of PLLInst_0 : label is "253.500000";
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "253.500000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "253.500000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "253.500000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "25.350000";
