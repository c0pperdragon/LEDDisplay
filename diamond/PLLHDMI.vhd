...
-- Module  Version: 5.7
--C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLLHDMI -lang vhdl -synth lse -arch xo2c00 -type pll -fin 25.175 -fclkop 251.75 -fclkop_tol 0.0 -fclkos 251.75 -fclkos_tol 0.0 -fclkos2 251.75 -fclkos2_tol 0.0 -fclkos3 251.75 -fclkos3_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 45 -trims_r -phases2 90 -phases3 135 -phase_cntl STATIC -fb_mode 1 

-- Sun Jan 04 14:16:28 2026
...
architecture Structure of PLLHDMI is
    ...
    attribute FREQUENCY_PIN_CLKOS3 of PLLInst_0 : label is "251.750000";
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "251.750000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "251.750000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "251.750000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "25.175000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  10, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLLHDMI is
    for Structure
