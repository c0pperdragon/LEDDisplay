...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n PLLHDMI -lang verilog -synth lse -arch xo2c00 -type pll -fin 25.175 -fclkop 25.175 -fclkop_tol 0.0 -fclkos 251.75 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1  */
/* Sat Oct 18 23:55:35 2025 */


`timescale 1 ns / 1 ps
module PLLHDMI (CLKI, CLKOP, CLKOS)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="251.750000" */
             /* synthesis FREQUENCY_PIN_CLKOP="25.175000" */
             /* synthesis FREQUENCY_PIN_CLKI="25.175000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 251.750000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 25.175000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 25.175000
